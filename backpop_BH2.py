...
#MBH: 9.80  +/- 0.20
#Mstar: 0.93 +/- 0.05
mean = np.array([8.94, 1.07, 1276.7, 0.518])
cov = np.array([[0.34**2, 0, 0, 0], [0, 0.19**2, 0, 0], [0, 0, 0.6**2, 0], [0, 0, 0, 0.001**2]])
...
np.savez(paths.data / 'BH1/bh2_1_p15_115',nwalkers=n_walkers,n_steps=n_steps,chain=sampler.chain)
